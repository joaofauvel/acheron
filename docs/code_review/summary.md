...
5. **Bundle E — Worker SDK typing and orchestrator cleanup:** `TYPE-008`, `TYPE-011`, `MAINT-022`, `MAINT-023` [verified in `5da1c71`].
6. **Bundle F — Health-state expiry:** `CORR-012` [verified in `c723592`].
