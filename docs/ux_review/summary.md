...
| OPS | C | 1 medium, 1 low | 4 | 31 stories; recovery CLI journeys now verified, with remaining durable-dashboard gaps |
| MAINT | C | 3 high, 2 medium | 7 | 19 stories; recovery, retention, and worker-history journeys now verified |
